...
export default function QuizCard({ quiz }: { quiz: Quiz }) {
  return (
    <div className="bg-white flex flex-col justify-between gap-y-5 rounded-2xl p-3.5 md:w-1/2 w-full md:max-w-96 lg:w-96 h-48 lg:hover:scale-105 transition-all duration-150 ease-linear">
