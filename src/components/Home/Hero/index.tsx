...
export default function Hero() {
  ...
  return (
    <section className="min-h-[calc(100dvh-4rem)] lg:min-h-[calc(100dvh-6rem)] flex flex-col justify-center gap-y-7 lg:flex-row w-full md:items-center py-12 lg:py-0 mt-5 lg:mt-0">
